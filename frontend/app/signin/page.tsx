              ...
              <div>
                ...
                <div className="mt-1 relative">
                  <input
                    ...
                    className="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm border p-3 pr-10"
                    placeholder="••••••••"
                  />
                  <button
                    type="button"
